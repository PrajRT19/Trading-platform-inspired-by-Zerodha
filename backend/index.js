...
app.post("/newOrder", async (req, res) => {
  try {
    ...
    if (!name || !qty || !price) {
      ...
      return res.status(400).json({ message: "Missing required fields: name, qty, price" });
    }
    ...
    if (qtyNum <= 0) {
      console.error("Invalid quantity:", qtyNum);
    ...
    console.log("Order saved successfully to MongoDB:", savedOrder);
